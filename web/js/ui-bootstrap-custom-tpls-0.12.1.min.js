...
angular.module("ui.bootstrap", ["ui.bootstrap.tpls", "ui.bootstrap.datepicker", "ui.bootstrap.dateparser", "ui.bootstrap.position"]), angular.module("ui.bootstrap.tpls", ["template/datepicker/datepicker.html", "template/datepicker/day.html", "template/datepicker/month.html", "template/datepicker/popup.html", "template/datepicker/year.html"]), angular.module("ui.bootstrap.datepicker", ["ui.bootstrap.dateparser", "ui.bootstrap.position"]).constant("datepickerConfig", {
  ...
  minDate: null,
  maxDate: null
}).controller("DatepickerController", ["$scope", "$attrs", "$parse", "$interpolate", "$timeout", "$log", "dateFilter", "datepickerConfig", function (e, t, a, n, i, r, o, l) {
  var d = this, c = {$setViewValue: angular.noop};
  this.modes = ["day", "month", "year"], angular.forEach(["formatDay", "formatMonth", "formatYear", "formatDayHeader", "formatDayTitle", "formatMonthTitle", "minMode", "maxMode", "showWeeks", "startingDay", "yearRange"], function (a, i) {
    ...
    var t = d.activeDate.getFullYear() + e * (d.step.years || 0), a = d.activeDate.getMonth() + e * (d.step.months || 0);
  ...
  e.$on("datepicker.focus", s), e.keydown = function (t) {
    ...
    if (a && !t.shiftKey && !t.altKey)if (t.preventDefault(), t.stopPropagation(), "enter" === a || "space" === a) {
  ...
  return {
    ...
    link: function (t, a, n, i) {
      ...
      function o(e, t) {
        var a = new Array(t), n = new Date(e), i = 0;
      ...
      t.showWeeks = i.showWeeks, i.step = {months: 1}, i.element = a;
      var d = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
      i._refreshView = function () {
        var a = i.activeDate.getFullYear(), n = i.activeDate.getMonth(), r = new Date(a, n, 1), d = i.startingDay - r.getDay(), c = d > 0 ? 7 - d : -d, s = new Date(r);
        c > 0 && s.setDate(-c + 1);
        for (var u = o(s, 42), p = 0; 42 > p; p++)u[p] = angular.extend(i.createDateObject(u[p], i.formatDay), {
          secondary: u[p].getMonth() !== n,
          uid: t.uniqueId + "-" + p
        });
        t.labels = new Array(7);
        for (var f = 0; 7 > f; f++)t.labels[f] = {abbr: e(u[f].date, i.formatDayHeader), full: e(u[f].date, "EEEE")};
        if (t.title = e(i.activeDate, i.formatDayTitle), t.rows = i.split(u, 7), t.showWeeks) {
          t.weekNumbers = [];
          for (var h = l(t.rows[0][0].date), g = t.rows.length; t.weekNumbers.push(h++) < g;);
        }
  ...
  return {
    ...
    require: "^datepicker",
    link: function (t, a, n, i) {
      i.step = {years: 1}, i.element = a, i._refreshView = function () {
        for (var a = new Array(12), n = i.activeDate.getFullYear(), r = 0; 12 > r; r++)a[r] = angular.extend(i.createDateObject(new Date(n, r, 1), i.formatMonth), {uid: t.uniqueId + "-" + r});
        t.title = e(i.activeDate, i.formatMonthTitle), t.rows = i.split(a, 3)
      }, i.compare = function (e, t) {
  ...
  return {
    ...
    link: function (e, t, a, n) {
      ...
      var r = n.yearRange;
      n.step = {years: r}, n.element = t, n._refreshView = function () {
        for (var t = new Array(r), a = 0, o = i(n.activeDate.getFullYear()); r > a; a++)t[a] = angular.extend(n.createDateObject(new Date(o + a, 0, 1), n.formatYear), {uid: e.uniqueId + "-" + a});
        e.title = [t[0].label, t[r - 1].label].join(" - "), e.rows = n.split(t, 5)
      }, n.compare = function (e, t) {
        return e.getFullYear() - t.getFullYear()
      }, n.handleKeyDown = function (e) {
        var t = n.activeDate.getFullYear();
        "left" === e ? t -= 1 : "up" === e ? t -= 5 : "right" === e ? t += 1 : "down" === e ? t += 5 : "pageup" === e || "pagedown" === e ? t += ("pageup" === e ? -1 : 1) * n.step.years : "home" === e ? t = i(n.activeDate.getFullYear()) : "end" === e && (t = i(n.activeDate.getFullYear()) + r - 1), n.activeDate.setFullYear(t)
      }, n.refreshView()
    }
  }
  ...
  appendToBody: !1,
  showButtonBar: !0
}).directive("datepickerPopup", ["$compile", "$parse", "$document", "$position", "dateFilter", "dateParser", "datepickerPopupConfig", function (e, t, a, n, i, r, o) {
  return {
    restrict: "EA",
    require: "ngModel",
    ...
    link: function (l, d, c, s) {
      ...
      var f, h = angular.isDefined(c.closeOnDateSelection) ? l.$parent.$eval(c.closeOnDateSelection) : o.closeOnDateSelection, g = angular.isDefined(c.datepickerAppendToBody) ? l.$parent.$eval(c.datepickerAppendToBody) : o.appendToBody;
      ...
      c.datepickerOptions && angular.forEach(l.$parent.$eval(c.datepickerOptions), function (e, t) {
        ...
        if (c[e]) {
          var a = t(c[e]);
          if (l.$parent.$watch(a, function (t) {
              l.watchData[e] = t
            }), y.attr(u(e), "watchData." + e), "datepickerMode" === e) {
            var n = a.assign;
      ...
      }), c.dateDisabled && y.attr("date-disabled", "dateDisabled({ date: date, mode: mode })"), s.$parsers.unshift(p), l.dateSelection = function (e) {
        angular.isDefined(e) && (l.date = e), s.$setViewValue(l.date), s.$render(), h && (l.isOpen = !1, d[0].focus())
      }, d.bind("input change keyup", function () {
        l.$apply(function () {
          l.date = s.$modelValue
        })
      }), s.$render = function () {
        var e = s.$viewValue ? i(s.$viewValue, f) : "";
        d.val(e), l.date = p(s.$modelValue)
      };
      var D = function (e) {
      ...
      d.bind("keydown", b), l.keydown = function (e) {
        27 === e.which ? (e.preventDefault(), e.stopPropagation(), l.close()) : 40 !== e.which || l.isOpen || (l.isOpen = !0)
      }, l.$watch("isOpen", function (e) {
        e ? (l.$broadcast("datepicker.focus"), l.position = g ? n.offset(d) : n.position(d), l.position.top = l.position.top + d.prop("offsetHeight"), a.bind("click", D)) : a.unbind("click", D)
      }), l.select = function (e) {
        if ("today" === e) {
          var t = new Date;
      ...
      var v = e(m)(l);
      m.remove(), g ? a.find("body").append(v) : d.after(v), l.$on("$destroy", function () {
        v.remove(), d.unbind("keydown", b), a.unbind("click", D)
      })
    }
  }
  ...
  function a(e) {
    ...
    return angular.forEach(i, function (t, i) {
      var r = e.indexOf(i);
      if (r > -1) {
        e = e.split(""), n[r] = "(" + t.regex + ")", e[r] = "$";
        for (var o = r + 1, l = r + i.length; l > o; o++)n[o] = "", e[o] = "$";
        e = e.join(""), a.push({index: r, apply: t.apply})
      }
    }), {regex: new RegExp("^" + n.join("") + "$"), map: t(a, "index")}
  }
  ...
  this.parse = function (t, i) {
    ...
    i = e.DATETIME_FORMATS[i] || i, this.parsers[i] || (this.parsers[i] = a(i));
    var r = this.parsers[i], o = r.regex, l = r.map, d = t.match(o);
    if (d && d.length) {
      for (var c, s = {year: 1900, month: 0, date: 1, hours: 0}, u = 1, p = d.length; p > u; u++) {
        var f = l[u - 1];
        f.apply && f.apply.call(s, d[u])
      }
      return n(s.year, s.month, s.date) && (c = new Date(s.year, s.month, s.date, s.hours)), c
    }
  }
  ...
  return {
    position: function (t) {
      var a = this.offset(t), n = {top: 0, left: 0}, r = i(t[0]);
      ...
      var i, r, o, l, d = a.split("-"), c = d[0], s = d[1] || "center";
      ...
      switch (c) {
        case"right":
          ...
          break;
        case"left":
          l = {top: p[s](), left: i.left - r};
          break;
        case"bottom":
          l = {top: p[c](), left: u[s]()};
          break;
        default:
          l = {top: i.top - o, left: u[s]()}
      }
      return l
    }
  }
