...
qwesta.controller("QwestaCtrl", ["$scope", "$http", "$interval", function (a, b) {
  ...
  initCharts(), a.initDate = (new Date).toDateString(), a.currentGraph = 0, a.startDate = Date.today(), a.minDate = Date.today(), a.maxDate = Date.today(), a.format = "dd.MM.yyyy", a.data = {
    temperature: 0,
    humidity: 0,
    wind: 0,
    rain: 0,
    ...
    a.set(a.currentGraph)
  };
  var d = function () {
    return "&day=" + a.startDate.getDate() + "&month=" + (a.startDate.getMonth() + 1) + "&year=" + a.startDate.getFullYear()
  }, e = function (b) {
    Date.today().addDays(b).compareTo(a.startDate) < 0 && (a.startDate = Date.today().addDays(b))
  };
  a.set = function (b) {
    a.currentGraph = b;
    ...
    switch ($("#graph" + b).addClass("qwesta-stats-selected"), b) {
      case 0:
        f += "multi&range=day&temperature" + d(), g = drawTemperatureChart;
        break;
      case 1:
      ...
      case 2:
        ...
        break;
      case 3:
        f += "multi&range=day&humidity&day=" + d(), g = drawHumidityChart;
        break;
      case 4:
      ...
      case 5:
        ...
        break;
      case 6:
        f += "multi&range=day&wind&day=" + d(), g = drawWindChart;
        break;
      case 7:
      ...
      case 8:
        ...
        break;
      case 9:
        f += "multi&range=day&rain&day=" + d(), g = drawRainChart;
        break;
      case 10:
