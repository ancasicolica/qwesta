var initCharts = function () {
  ...
  if (google) {
    ...
    google.load("visualization", "1.0", {
      packages: ["corechart"], callback: function () {
        ...
        for (var c = 0; c < b.length; c++)a.addRow([convertMySqlTimeToDate(b[c].tsLocal), parseFloat(b[c].temperatureMin), parseFloat(b[c].temperatureAvg), parseFloat(b[c].temperatureMax)]);
        var d = {curveType: "function", legend: {position: "bottom"}, title: "Temperatur"};
        console.log(screen.width);
        var e = new google.visualization.LineChart(document.getElementById("chart"));
        e.draw(a, d)
      }
    })
  }
  ...
  if (google) {
    ...
    google.load("visualization", "1.0", {
      packages: ["corechart"], callback: function () {
        var a = new google.visualization.DataTable;
        a.addColumn("datetime", "Zeit"), a.addColumn("number", "Regen");
