...
qwesta.controller("QwestaCtrl", ["$scope", "$http", "$interval", function (a, b) {
  ...
  a.set = function (b) {
    ...
    a.getCurrentData(c + "?view=current", function (b) {
      console.log(b), b.success ? (a.data.temperature = b.data[0].temperature, a.data.humidity = b.data[0].humidity, a.data.wind = b.data[0].wind, a.data.rain = b.data[0].raindifference) : (a.data.temperature = 0, a.data.humidity = 0, a.data.wind = 0, a.data.rain = 0)
    })
