var initCharts = function () {
  ...
  if (google) {
    ...
    google.load("visualization", "1.0", {
      packages: ["corechart"], callback: function () {
        ...
        a.addColumn("datetime", "Zeit"), a.addColumn("number", "Temperatur Min"), a.addColumn("number", "Temperatur Avg"), a.addColumn("number", "Temperatur Max");
  ...
  if (google) {
    ...
    google.load("visualization", "1.0", {
      packages: ["corechart"], callback: function () {
        var a = new google.visualization.DataTable;
        a.addColumn("datetime", "Zeit"), a.addColumn("number", "Wind Avg"), a.addColumn("number", "Wind Max");
...
qwesta.controller("QwestaCtrl", ["$scope", "$http", "$interval", function (a, b) {
  ...
  initCharts(), a.initDate = (new Date).toDateString(), a.currentGraph = 0, a.startDate = Date.today(), a.minDate = Date.today(), a.maxDate = Date.today(), a.format = "dd.MM.yyyy", a.data = {
    ...
    console.log(a.startDate), a.set(a.currentGraph)
  };
  var d = function () {
    return "&day=" + a.startDate.getDate() + "&month=" + (a.startDate.getMonth() + 1) + "&year=" + a.startDate.getFullYear()
  }, e = function (b) {
    console.log("A:" + a.startDate.toDateString()), Date.today().addDays(b).compareTo(a.startDate) < 0 && (a.startDate = Date.today().addDays(b)), console.log("B:" + a.startDate.toDateString())
  };
  a.set = function (b) {
    a.currentGraph = b;
